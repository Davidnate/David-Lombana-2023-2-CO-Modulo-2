...
from dino_runner.utils.constants import FONT_STYLE,BG, ICON, SCREEN_HEIGHT, SCREEN_WIDTH, TITLE, FPS, DEFAULT_TYPE
...
class Game:
    ...
    def show_menu(self):
        ...
        if self.death_count.count == 0:
            ...
            self.menu.draw(self.screen, f'High score: {self.highest_score.count}', half_screen_width, 400, )
